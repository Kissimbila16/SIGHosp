...
var handleMobileSidebarToggle = function() {
    ...
    $('[data-click=right-sidebar-toggled]').on('click', function (e) {
        e.stopPropagation();
    ...
    $('[data-click=sidebar-toggled]').on('click', function (e) {
        e.stopPropagation();
...
var handleUnlimitedTopMenuRender = function() {
    ...
    $('[data-click="next-menu"]').on('click', function (e) {
        e.preventDefault();
        handleMenuButtonAction(this,'next');
    });

    // handle menu prev button click action
    $('[data-click="prev-menu"]').on('click', function (e) {
        e.preventDefault();
...
var handleToggleNavProfile = function() {
    ...
    $('[data-toggle="nav-profile"]').on('click', function (e) {
        e.preventDefault();
...
var handleToggleNavbarSearch = function() {
    ...
    $('[data-dismiss="navbar-search"]').on('click', function (e) {
        e.preventDefault();
